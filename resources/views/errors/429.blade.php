...
<head>
    ...
    <title>Too Many Requests - LegalHR Tanzania</title>
...
<body>
    <div class="error-container">
        <div class="error-left">
            ...
            <div class="floating-shape" style="width:24rem;height:24rem;background:#ea580c;bottom:-20%;right:-10%;"></div>
        ...
        <div class="error-right">
            <div class="error-card">
                <div style="display:inline-flex;align-items:center;justify-content:center;width:4rem;height:4rem;background:#fef3c7;border-radius:1rem;margin-bottom:1.5rem;">
                    <i data-feather="alert-triangle" style="width:2rem;height:2rem;color:#d97706;"></i>
                </div>

                <div class="error-code">429</div>
                <h2 style="font-size:1.5rem;font-weight:800;color:#0f172a;margin:0.75rem 0 0.5rem;">Too Many Requests</h2>
