...
<head>
    ...
    <title>Page Not Found - LegalHR Tanzania</title>
...
<body>
    <div class="error-container">
        <div class="error-left">
            <div class="floating-shape" style="width:16rem;height:16rem;background:#6366f1;top:-10%;left:-10%;"></div>
            <div class="floating-shape" style="width:24rem;height:24rem;background:#2563eb;bottom:-20%;right:-10%;"></div>
        ...
        <div class="error-right">
            <div class="error-card">
                <div style="display:inline-flex;align-items:center;justify-content:center;width:4rem;height:4rem;background:#eff6ff;border-radius:1rem;margin-bottom:1.5rem;">
                    <i data-feather="search" style="width:2rem;height:2rem;color:#2563eb;"></i>
                </div>

                <div class="error-code">404</div>
                <h2 style="font-size:1.5rem;font-weight:800;color:#0f172a;margin:0.75rem 0 0.5rem;">Page Not Found</h2>
                ...
                <div style="display:flex;flex-direction:column;gap:0.75rem;">
                    <a href="javascript:history.back()" class="error-btn-primary">
                        <i data-feather="arrow-left" style="width:1rem;height:1rem;"></i>
                        Go Back
                    </a>
