...
<head>
    ...
    <title>Page Expired - LegalHR Tanzania</title>
...
<body>
    <div class="error-container">
        <div class="error-left">
            <div class="floating-shape" style="width:16rem;height:16rem;background:#f59e0b;top:-10%;left:-10%;"></div>
            <div class="floating-shape" style="width:24rem;height:24rem;background:#d97706;bottom:-20%;right:-10%;"></div>
        ...
        <div class="error-right">
            <div class="error-card">
                <div style="display:inline-flex;align-items:center;justify-content:center;width:4rem;height:4rem;background:#fef3c7;border-radius:1rem;margin-bottom:1.5rem;">
                    <i data-feather="clock" style="width:2rem;height:2rem;color:#d97706;"></i>
                </div>

                <div class="error-code">419</div>
                <h2 style="font-size:1.5rem;font-weight:800;color:#0f172a;margin:0.75rem 0 0.5rem;">Page Expired</h2>
                <p style="color:#64748b;font-size:0.9375rem;line-height:1.6;margin-bottom:2rem;">
                    Your session has expired due to inactivity. Please log in again to continue.
                </p>

                <div style="display:flex;flex-direction:column;gap:0.75rem;">
                    <a href="{{ url('/login') }}" class="error-btn-primary">
                        <i data-feather="log-in" style="width:1rem;height:1rem;"></i>
                        Log In Again
                    </a>
                    <a href="{{ url('/') }}" class="error-btn-outline">
                        <i data-feather="home" style="width:1rem;height:1rem;"></i>
                        Go to Home
                    </a>
                </div>
            </div>
