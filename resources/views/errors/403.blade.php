...
<head>
    ...
    <title>Access Denied - LegalHR Tanzania</title>
        ...
        <div class="error-right">
            <div class="error-card">
                <div style="display:inline-flex;align-items:center;justify-content:center;width:4rem;height:4rem;background:#fef2f2;border-radius:1rem;margin-bottom:1.5rem;">
                    <i data-feather="shield-off" style="width:2rem;height:2rem;color:#dc2626;"></i>
                </div>

                <div class="error-code">403</div>
                <h2 style="font-size:1.5rem;font-weight:800;color:#0f172a;margin:0.75rem 0 0.5rem;">Access Denied</h2>
