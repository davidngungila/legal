...
<div class="p-6">
    <div class="flex items-center justify-between mb-8">
        <div>
            <h1 class="text-3xl font-bold text-gray-900 font-manrope">Create Contract</h1>
            <p class="text-gray-600 mt-2">Generate a new employment agreement</p>
        </div>
        <div>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <textarea name="job_description" id="job_description" rows="6"
                        ...
                        placeholder="Enter the detailed job description and responsibilities...">{{ old('job_description') }}</textarea>
                        ...
                        <div>
                            ...
                            <select name="status" id="status" required
                                ...
                                @foreach($statuses as $status)
                                    <option value="{{ $status }}" {{ old('status', 'draft') == $status ? 'selected' : '' }}>{{ ucfirst(str_replace('_', ' ', $status)) }}</option>
                                @endforeach
                            </select>
