...
<div class="p-6">
    ...
    <div class="mb-8">
        ...
        <p class="text-gray-600 mt-2">Create a new job vacancy for recruitment</p>
    </div>

    <!-- Job Vacancy Form -->
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        <form id="jobVacancyForm" method="POST" action="{{ route('job-vacancy.store') }}" class="p-6 space-y-8">
            @csrf
            ...
            <div class="border-b border-gray-200 pb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input type="date" name="position_vacant_date" required
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
            ...
            <div class="border-b border-gray-200 pb-8" id="replacementSection" style="display: none;">
                ...
                <div>
                    ...
                    <textarea name="replacement_reason" rows="4" id="replacementReason"
                              class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                              placeholder="Please explain the reasons for this replacement..."></textarea>
            ...
            <div class="border-b border-gray-200 pb-8">
                ...
                <div>
                    ...
                    <textarea name="job_description" rows="6" required
                              class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                              placeholder="Provide a detailed description of the job responsibilities and requirements..."></textarea>
            ...
            <div class="border-b border-gray-200 pb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="number" name="min_age" min="18" max="65"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                    ...
                    <div>
                        ...
                        <input type="number" name="salary_range_min" min="0" step="0.01"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <input type="number" name="salary_range_max" min="0" step="0.01"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
                </div>
                <div class="grid grid-cols-1 gap-6 mt-6">
                    <div>
                        ...
                        <textarea name="academic_qualifications" rows="3"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                                  placeholder="e.g., Bachelor's degree in relevant field..."></textarea>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <textarea name="professional_qualifications" rows="3"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                                  placeholder="e.g., Professional certifications, licenses..."></textarea>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <textarea name="other_qualifications" rows="3"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                                  placeholder="e.g., Skills, experience, languages..."></textarea>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">
                            Additional Comments
                        ...
                        <textarea name="additional_comments" rows="3"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                                  placeholder="Any additional information about the position..."></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="flex justify-between">
                ...
                <div class="flex space-x-3">
                    ...
                    <button type="submit" id="submitBtn"
                        ...
                        <span id="btnText">Submit for Approval</span>
...
class JobVacancyManager {
    constructor() {
        this.form = document.getElementById('jobVacancyForm');
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const applicationDate = document.querySelector('input[name="application_date"]');
    if (applicationDate && !applicationDate.value) {
        const today = new Date();
        const yyyy = today.getFullYear();
        const mm = String(today.getMonth() + 1).padStart(2, '0');
        const dd = String(today.getDate()).padStart(2, '0');
        applicationDate.value = `${yyyy}-${mm}-${dd}`;
    }
});
</script>
@endpush
