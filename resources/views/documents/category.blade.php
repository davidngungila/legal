...
@section('title', $category . ' Documents - LegalHR Tanzania')
...
<div class="p-6">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
        <div class="flex items-center space-x-4">
            ...
            <div>
                <h1 class="text-3xl font-bold text-gray-900 font-manrope">{{ $category }} Documents</h1>
                <p class="text-gray-600 mt-2">{{ $documents->count() }} document(s) in this category</p>
            </div>
        </div>
